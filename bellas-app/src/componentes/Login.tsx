...
const Login = () => {
    ...
    useEffect(() => {
        ...
        .then((respuesta: AxiosResponse<any>) => {
            ...
            setDbUsers(respuesta.data)
        })
    }, [])
    
    const onFinish = (values: { user: any; password: any; }) => {
        console.log('Success:', values);

        let auth = dbUsers.filter(e => (e.correo === values.user || e.telefono === values.user) && e.contraseña === values.password );
        ...
        <div className='login'>
            ...
            >
                <div className='loginContent'>
                    <h2 className='loginSubtitulo'>Correo / Celular:</h2>
                    <Form.Item
                        name="user"
                        rules={[
                            {
